<div class="featuredContainer <?php echo $class_main_color; ?>">
    ...
    <div class="content">
        ...
        <div class="story hide">
            <span class="useCap">W</span>here do you think of when you look at this photograph? These two blue and gold macaws and hybrid macaws enjoy fabulous corns and apples and listen to <em>I wanna be free</em> every morning. You can meet them almost every morning outside an air-conditioner retailing shop; the shopkeeper is their master! The hybrid can say <em>Bye-bye</em> to you, while another yellow-naped amazon by the side does know to say <em>Good Morning</em> and <em>Kung Hai Fat Choy</em> to you! I have been observing the parrots for months, and one day I captured the moment that they were kissing. It's not easy to take the parrot photos outside the shop as there are too many blocking items around like trolleys, boxes and also the people around. When I found that there is a short mountain in the far side, I grasped this perfect timing with a 300mm reflex lens.
        </div>
        <div class="story hide">
